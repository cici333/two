...
public class MCODEVisualStyleAction extends AbstractVizAction
  implements CytoPanelComponentSelectedListener
{
  ...
  public MCODEVisualStyleAction(String title, CyApplicationManager applicationManager, CySwingApplication swingApplication, CyNetworkViewManager netViewManager, VisualMappingManager visualMappingMgr, ClusterUtil mcodeUtil)
  {
