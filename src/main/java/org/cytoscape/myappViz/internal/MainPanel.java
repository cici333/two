...
import org.cytoscape.myappViz.internal.algorithmPanels.EAGLEpanel;
import org.cytoscape.myappViz.internal.algorithmPanels.FAGECPanel;
import org.cytoscape.myappViz.internal.algorithmPanels.HCPINpanel;
import org.cytoscape.myappViz.internal.algorithmPanels.IPCApanel;
import org.cytoscape.myappViz.internal.algorithmPanels.OHPINpanel;
...
/*    
	public MainPanel() {
	 ...
	 public MainPanel(CySwingApplication swingApplication, ClusterUtil mcodeUtil)
	  {
	...
	private JScrollPane createAlgorithmPanel() {
        ...
        JRadioButton algorithm1 = new JRadioButton("MCODE", currentParamsCopy.getAlgorithm().equals(ParameterSet.MCODE));
   ...
   private JPanel createBottomPanel() {
    ...
    private class AlgorithmAction extends AbstractAction {
        public void actionPerformed(ActionEvent e) {
            ...
            option1.setVisible(currentParamsCopy.getAlgorithm().equals(ParameterSet.MCODE));
